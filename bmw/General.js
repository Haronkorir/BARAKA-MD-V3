...
zokou({ nomCom: "dev", categorie: "General", reaction: "🚘" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "Baraka", numero: "255679513639" },
      { nom: "᚛Baraka bega᚜", numero: "255762190568" },
      { nom: "Ibrahim Adams", numero: "25410772666" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "WELCOME TO BARAKA MD HELP CENTER! ASK FOR HELP FROM ANY OF THE DEVELOPERS BELOW:\n\n";
